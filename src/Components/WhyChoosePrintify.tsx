...
const Features:React.FC = () =>{
    return(
        <section className="min-h-screen flex flex-col items-center justify-center bg-blue-50 px-6 md:px-10">
            <h2 className="text-5xl font-bold text-blue-500 mb-10 text-center">Why Choose Printify?</h2>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
                    <div className="p-6 shadow-lg rounded-2xl text-center hover:scale-105 transition-transform duration-300 bg-white">
